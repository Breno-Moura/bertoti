...
class Client implements Observer{
    ...
    public void update(int value, String name) {
        System.out.println(this.name+": "+name+" valor alterado para: "+value);
...
public class CompositeMain {
    public static void main(String[] args) {
        Client subClient = new Client("Cliente chato");
        Client upClient = new Client("Cliente legal");
        upClient.add(subClient);

        CompanyStock companyStock = new CompanyStock("Fatec");
